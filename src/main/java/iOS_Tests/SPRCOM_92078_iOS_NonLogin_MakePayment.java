...
public class SPRCOM_92078_iOS_NonLogin_MakePayment extends MainBase {
    ...
    public void SPRCOM_106302() throws InterruptedException
    {
        Button_PayWithCard();
        Camera_Access();
        icon_MoreInfo();
        Button_Continue_Default();
        Button_Continue_Default2();
        Payment_Amount();
        Payment_Amount2();
        Payment_SpecialSign();
        Payment_Name();
    ...
    private void Button_PayWithCard()
    {
    ...
    private void icon_MoreInfo() throws InterruptedException
    {
        saveTextLog_Allure_er("Expected Result XXX");
    ...
    @Step("4. Payment page - Default status of button 'Continue'")
    private void Button_Continue_Default()
    {
    ...
    @Step("5. Payment page - Status of button 'Continue' after payment info filled")
    private void Button_Continue_Default2()
    {
    ...
    // =======================================
    // Amount part tests
    @Step("6. Payment page - Amount cases - less than $1")
    private void Payment_Amount() throws InterruptedException
    {
        saveTextLog_Allure_er("Expected Result XXX");
        // Step1
        iosDriver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
    ...
    @Step("7. Payment page - Amount cases - More than $2000")
    private void Payment_Amount2() throws InterruptedException
    {
        saveTextLog_Allure_er("Expected Result XXX");
        iosDriver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
    ...
    @Step("8. Payment page - Test with special sign on the page")
    private void Payment_SpecialSign() throws InterruptedException
    {
        saveTextLog_Allure_er("Expected Result XXX");
        iosDriver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
    ...
    // =======================================
    // Name part test
    @Step("9. Payment page - Test with name textFiled on the page")
    private void Payment_Name() throws InterruptedException
    {
        saveTextLog_Allure_er("Expected Result XXX");
        //Step1
    ...
    // Zip code tests
    @Step("10. Payment page - Test with ZIP textFiled on the page")
    @Description("Payment page - ZIP textField tests")
    private void Payment_zip() throws InterruptedException
    {
        saveTextLog_Allure_er("Expected Result XXX");
        //Step1
    ...
    // Cancel
    @Step("11. Payment page - Button Cancel - End Test Also")
    private void Payment_Cancel() throws InterruptedException
    {
        saveTextLog_Allure_er("Expected Result XXX ...");
        iosDriver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
