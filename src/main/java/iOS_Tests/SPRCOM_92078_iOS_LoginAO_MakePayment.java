...
public class SPRCOM_92078_iOS_LoginAO_MakePayment extends MainBase {
    ...
    @Story("SPRCOM-106902 My Sprint App iOS LoginAO Payment - Phase 2 - Basic Payment Functional Tests")
    ...
    @Story("SPRCOM-106904 LoginAO ApplePay - Default Payment")
    ...
    @Severity(SeverityLevel.NORMAL)
    @Story("SPRCOM-106916 LoginAO Add New Card to account - from payment page")
    ...
    @Severity(SeverityLevel.NORMAL)
    @Story("SPRCOM-106918 LoginAO Add New Checking to account - from payment page")
