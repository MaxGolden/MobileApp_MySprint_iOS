...
@Epic("SPRCOM-92078")
@Feature("My Sprint App iOS - Payment")
public class iOS_NonLogin_MakePayment extends MainBase {

    @Test(groups = {"NonLogin", "MakePayment"}, priority = 1, testName = "SPRCOM-108310")
    ...
    // Default parts test
    @Test(groups = {"NonLogin", "MakePayment"}, priority = 2, testName = "SPRCOM-108311")
    @Description("App will ask user to allow access of Camera'")
    @Severity(SeverityLevel.NORMAL)
    @Story("Allow Camera access at the payment page'")
    public void SPRCOM_106311()
    {
    ...
    @Test(groups = {"NonLogin", "MakePayment"}, priority = 3, testName = "SPRCOM-106312")
    @Description("Click the 'More info' icon to make sure it works")
    @Severity(SeverityLevel.TRIVIAL)
    @Story("Payment page 'more info' icon functional test")
    public void SPRCOM_106312() throws InterruptedException
    {
    ...
    @Test(groups = {"NonLogin", "MakePayment"}, priority = 3, testName = "SPRCOM-106314")
    @Description("The button default status should be disabled")
    @Severity(SeverityLevel.TRIVIAL)
    @Story("Payment page - Default status of button 'Continue'")
    public void SPRCOM_106314()
    {
        iosDriver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
    ...
    @Test(groups = {"NonLogin", "MakePayment"}, priority = 4, testName = "SPRCOM-106316")
    @Description("Fill the correct payment info and make sure 'Continue' button status is enabled")
    @Severity(SeverityLevel.TRIVIAL)
    @Story("Payment page - Status of button 'Continue' after payment info filled")
    public void SPRCOM_106316()
    {
        iosDriver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
    ...
    // =======================================
    // Amount part tests
    @Test(groups = {"NonLogin", "MakePayment"}, priority = 5, testName = "SPRCOM-106318")
    @Description("Payment amount - Amount Case: Less than $1")
    @Severity(SeverityLevel.NORMAL)
    @Story("Payment page - Amount cases")
    public void SPRCOM_106318() throws InterruptedException
    {
        // Step1
        iosDriver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
    ...
    @Test(groups = {"NonLogin", "MakePayment"}, priority = 5, testName = "SPRCOM-106319")
    @Description("Payment amount - Amount Case: More than $2000.")
    @Severity(SeverityLevel.NORMAL)
    @Story("Payment page - Amount cases")
    public void SPRCOM_106319() throws InterruptedException
    {
    ...
    @Test(groups = {"NonLogin", "MakePayment"}, priority = 8, testName = "SPRCOM-106320")
    @Description("Payment amount - textField special sign tests")
    @Severity(SeverityLevel.NORMAL)
    @Story("Payment page - Test with special sign on the page")
    public void SPRCOM_106320() throws InterruptedException
    {
        iosDriver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
...
//    @Step("If amount textField has special sign, the status of the button 'Continue' should be disabled")
...
//    }
    ...
    // =======================================
    // Name part test
    @Test(groups = {"NonLogin", "MakePayment"}, priority = 11, testName = "SPRCOM-106322")
    @Description("Payment page - name textField tests")
    @Severity(SeverityLevel.TRIVIAL)
    @Story("Payment page - Test with name textFiled on the page")
    public void SPRCOM_106322() throws InterruptedException
    {
        //Step1
    ...
    // Zip code tests
    @Test(groups = {"NonLogin", "MakePayment"}, priority = 13, testName = "SPRCOM-106324")
    @Description("Payment page - ZIP textField tests")
    @Severity(SeverityLevel.TRIVIAL)
    @Story("Payment page - Test with ZIP textFiled on the page")
    public void SPRCOM_106324() throws InterruptedException
    {
        //Step1
    ...
    @Description("Payment page - Button Cancel - End Test Also")
    @Severity(SeverityLevel.TRIVIAL)
    @Story("Payment page - Button Cancel - End Test Also")
    public void SPRCOM_106328_1() throws InterruptedException
    {
        iosDriver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
