...
public class SPRCOM_106800_iOS_LoginAO_AddCard extends MainBase {

    @Test(groups = {"NonLogin", "MakePayment"}, priority = 4, dataProvider = "CardNumber",
    ...
    @Story("SPRCOM-106808 Payment Test with card types(Number)")
    public void SPRCOM_106808(String cardNum, String cardType, String cardCountry)
    {
        SPRCOM_106808_Step1();
        SPRCOM_106808_Step2();
        ...
        if(findByAccessibilityID_Exist(2, Last4digits) & !findByID_Exist(2, "(Expired)")) {
            ...
            SPRCOM_106808_Step_extra();
            SPRCOM_106808_Step3(cardNum, cardType);
            SPRCOM_106808_Step4();
            SPRCOM_106808_Step5();
            SPRCOM_106808_Step6();
            SPRCOM_106808_Step7();
    ...
    private void SPRCOM_106808_Step1()
    {
    ...
    private void SPRCOM_106808_Step2()
    {
    ...
    private void SPRCOM_106808_Step_extra()
    {
    ...
    private void SPRCOM_106808_Step3(String cardNum, String cardType)
    {
    ...
    private void SPRCOM_106808_Step4()
    {
    ...
    private void SPRCOM_106808_Step5()
    {
        saveTextLog_Allure_er("Bottom payment sheet is displayed");
    ...
    private void SPRCOM_106808_Step6()
    {
    ...
    private void SPRCOM_106808_Step7()
    {
        saveTextLog_Allure_er("Payment result page is displayed");
    ...
    private void SPRCOM_106808_Step8()
    {
