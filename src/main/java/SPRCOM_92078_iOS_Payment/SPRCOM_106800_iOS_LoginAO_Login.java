...
public class SPRCOM_106800_iOS_LoginAO_Login extends MainBase {
    ...
    public void SPRCOM_106802(String Env, String MDN, String ACCusername, String ACCpassword) throws InterruptedException
    {
        ...
        try {
            if(payment_m.size() > 0) {
                ...
                iosDriver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
                iosDriver.findElementById("Username").sendKeys(ACCusername);
                iosDriver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
                iosDriver.findElementById("Password").sendKeys(ACCpassword);
